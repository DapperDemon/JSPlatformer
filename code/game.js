...
Floater.prototype.act = function(step){
	...
	var wobblePos = Math.sin(this.wobble) * wobbleDist / 10;
...
Flag.prototype.act = function(step){
	this.wobble += step * wobbleSpeed * 10;
	var wobblePos = Math.sin(this.wobble) * wobbleDist / 10;
	this.pos = this.basePos.plus(new Vector(wobblePos,wobblePos));
};
...
//floater powerup function
function floatPowerUp(){
	gravity = -gravity;
}
